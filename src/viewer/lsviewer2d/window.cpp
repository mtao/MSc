...
LevelSetViewer::LevelSetViewer(const QString & prefix , const QString & file_extension, QWidget * parent, Qt::WFlags flags): Viewer<LevelSetViewerWidget>(prefix,file_extension,parent,flags){init();}
void LevelSetViewer::init()
{
    control=0;
    shaderName=0;
...
void LevelSetViewer::createControls()
{
    if(control)
        delete control;
...
void LevelSetViewer::newShaderPrefix()
{
