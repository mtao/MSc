...
PointViewer::PointViewer(const QString & prefix , const QString & file_extension, QWidget * parent, Qt::WFlags flags): Viewer<PointViewerWidget>(prefix,file_extension,parent,flags){init();}
...
void PointViewer::createControls()
{
    if(control)
        delete control;
...
void PointViewer::newShaderPrefix()
{
