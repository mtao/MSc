...
void GridViewer::createControls()
{
    ...
    gridType->insertItem(GridViewerWidget::GT_WFLUX       , "W Flux"        );
    gridType->insertItem(GridViewerWidget::GT_DUFLUX       , "U Flux"        );
    gridType->insertItem(GridViewerWidget::GT_DVFLUX       , "V Flux"        );
    gridType->insertItem(GridViewerWidget::GT_DWFLUX       , "W Flux"        );
    gridType->insertItem(GridViewerWidget::GT_CELL        , "Cell"          );
    gridType->insertItem(GridViewerWidget::GT_MARCHINGCUBE, "Marching Cubes");
