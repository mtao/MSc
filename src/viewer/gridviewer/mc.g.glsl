...
/*
void emitPoint(int i)
{
        vec3 pos = gl_in[0].gl_Position.xyz + vertDecals[i]*.5;
    f_color = vec4(texture(dataFieldTex, pos).a/255.0,0.0,0.0,1.0);
    gl_Position = modelViewProjectionMatrix * vec4(pos-vec3(0.5),1.0);EmitVertex();
}
*/
